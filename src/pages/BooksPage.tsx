              ...
              <div className="mb-6">
                ...
                <form onSubmit={handleSearch} className="flex items-center h-10">
                  <input
                    ...
                    className="w-full border border-gray-300 text-sm rounded-l px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                  <button
                    type="submit"
                    className="bg-blue-800 text-white p-2 py-2.5 rounded-r hover:bg-blue-700 transition-colors"
                  >
                    <Search size={18} />
                  </button>
                </form>
